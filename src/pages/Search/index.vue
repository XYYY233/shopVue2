    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="details clearfix">
            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active : isOne}" @click="changeOrder('1')">
                  <a >综合 <span v-show="isOne" >{{ isAsc ? '⬆️' : '⬇️' }}</span> </a>
                </li>
                <li :class="{active : isTwo}"  @click="changeOrder('2')">
                  <a >价格<span v-show="isTwo">{{ isAsc ? '⬆️' : '⬇️' }}</span></a>
                </li>
          ...
          <Pagination :pageNo="searchParams.pageNo" :pageSize="searchParams.pageSize" :totle="total" :continues="5" @getPageNo="getPageno"/>
        </div>
      </div>
    </div>
  </div>
  ...
  export default {
    ...
    methods:{
      ...
      attrInfo(attr,attrValue){
        let props = `${attr.attrId}:${attrValue}:${attr.attName}`
