  ...
  <div class="cart">
      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="(cart,index) in cartInfoList" :key="cart.id">
          ...
          <li class="cart-list-con5">
            ...
            <input autocomplete="off" type="text" value="1" @change="handler('change',$event.target.value*1,cart)" minnum="1" :value="cart.skuNum" class="itxt">
    ...
    <div class="cart-tool">
      <div class="select-all">
        <input class="chooseAll" type="checkbox" @change="updateAllCartChecked" :checked="isAllChecked">
        <span>全选</span>
      </div>
      <div class="option">
...
mapGetters
  export default {
    ...
    methods: {
      ...
      deleteCartById(cart){
        try {
          this.$store.dispatch('shopcart/reqDeleteCartBySkuId',cart.skuId)
          this.getData()
        } catch (error) {
          alert(error)
        }
