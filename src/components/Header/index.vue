    ...
    export default {
        ...
        methods: { 
            goSearch(){
                // 路由传参数
                //1.
                // this.$router.push('/search/'+this.keyword+'?kee='+this.keyword)
                let loacation = {name:"search",params:{keyword:this.keyword || undefined}}
                loacation.query = this.$route.query
                // console.log(this.$route.query)
                console.log(loacation)
                this.$router.push(loacation)
            },
            async logout(){
